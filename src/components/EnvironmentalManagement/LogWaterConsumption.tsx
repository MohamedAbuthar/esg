...
const LogWaterConsumption: React.FC = () => {
    ...
    <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 mt-6">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div>
            <Label htmlFor="sourceType" className="text-sm font-medium text-gray-700 mb-2 block">
              Source Type
            </Label>
            <div className="relative">
              <select
          ...
          {/* Volume Input */}
          <div>
            <Label htmlFor="volume" className="text-sm font-medium text-gray-700 mb-2 block">
              Volume (m³)
            </Label>
            <Input
              id="volume"
...
export default LogWaterConsumption;
